...
from signal_scrape_core.crawl_events import merge_profile_events, missing_seed_error_events  # noqa: E402
from signal_scrape_core.identity import apply_website_identity_gate  # noqa: E402
from signal_scrape_core.operations import domain_request_summary, latency_summary, peak_rss_bytes  # noqa: E402
...
def main() -> None:
    try:
        ...
        from signal_scrape_core.scrapy_crawler import SignalpostWebsiteSpider
